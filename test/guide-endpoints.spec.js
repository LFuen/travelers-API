...
// ====================
  ...
  describe(`GET /api/guides`, () => {
    ...
    context(`Given there are guides in the database`, () => {
      ...
      it(`gets the guides from the store`, () => {
        return supertest(app).get("/api/guides").expect(200, testGuide);
      });
    });
      ...
      it(`removes no bueno XSS attack content`, () => {
        return supertest(app)
          ...
          .expect((res) => {
            ...
            expect(res.body[0].recommendation).to.eql(
              expectedGuide.recommendation
            );
      ...
      it(`removes no bueno XSS attack content`, () => {
        return supertest(app)
          ...
          .expect((res) => {
            ...
            expect(res.body.recommendation).to.eql(
              expectedGuide.recommendation
            );
  ...
  describe(`GET /api/guides/:guide_id`, () => {
    ...
    context(`Given an xss attack on an guide`, () => {
      const badGuide = {
        id: 911,
        guide_type: "Food",
        city: "Evil City",
  ...
  describe(`POST /api/guides`, () => {
    ...
    it(`responds with 400 'Missing 'city' in the request body.'`, () => {
      ...
      return supertest(app)
        ...
        .send(missCity)
        .expect(400, {
          error: { message: `Missing 'city' in the request body.` },
        });
    });
    ...
    it(`responds with 400 'Missing 'recommendation' in the request body.' when missing recommendation`, () => {
      ...
      return supertest(app)
        ...
        .send(missRecom)
        .expect(400, {
          error: { message: `Missing 'recommendation' in the request body.` },
        });
    });
    ...
    it(`responds 400 'Missing 'comments' in the request body.' when missing comments`, () => {
      ...
      return supertest(app)
        ...
        .send(missComm)
        .expect(400, {
          error: { message: `Missing 'comments' in the request body.` },
        });
    });
...
// ====================
  ...
  describe(`PATCH /api/guides/:guide_id`, () => {
    context(`Given no guides`, () => {
      it(`responds with 404`, () => {
        const guideID = 123456;
    ...
    context(`Given there are guides in the database`, () => {
      ...
      it(`responds with 204 and updates the guide`, () => {
        const idToUpdate = 1;
        const updateGuide = {
          id: 1,
          guide_type: "test guide",
        ...
        const expectedGuide = {
          ...testGuides[idToUpdate - 1],
          ...updateGuide,
        };
        return supertest(app)
          .patch(`/api/guides/${idToUpdate}`)
          .set(`Authorization`, helpers.authHeader(testUser))
          .send(updateGuide)
          .expect(204)
          .then((res) =>
            supertest(app)
              .get(`/api/guides/${idToUpdate}`)
              .set(`Authorization`, helpers.authHeader(testUser))
              .expect(expectedGuide)
          );
      });
      ...
      it(`responds with 400 when no required fields are supplied`, () => {
        ...
        return supertest(app)
          ...
          .expect(400, {
            error: {
              message: `Request body must contain either 'guide_type', 'city', 'recommendation', or 'comments'`,
            },
          });
      });
      ...
      it(`responds with 204 when updating only a subset of fields`, () => {
        const idToUpdate = 2;
        const updateGuide = {
          guide_type: "Updated Guide Type",
        };
        const expectedGuide = {
          ...testGuide[idToUpdate - 1],
          ...updateGuide,
        };
